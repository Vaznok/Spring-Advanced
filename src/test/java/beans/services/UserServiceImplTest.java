...
public class UserServiceImplTest {
    ...
    public void testRegister() throws Exception {
        ...
        User user = new User(email, UUID.randomUUID().toString(), LocalDate.now(), "12345");
    ...
    public void testUsersGetByName() throws Exception {
        ...
        User addedUser = new User(UUID.randomUUID().toString(), testUser1.getName(), LocalDate.now(), "12345");
